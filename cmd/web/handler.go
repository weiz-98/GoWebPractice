...
import (
	...
	"GoWebPractice/internal/validator"
	"errors"
	"fmt"
	"net/http"
	"strconv"
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) { // Decode the form data into the userLoginForm struct.
